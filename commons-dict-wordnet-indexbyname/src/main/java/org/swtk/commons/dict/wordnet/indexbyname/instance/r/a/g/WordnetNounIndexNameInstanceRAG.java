package org.swtk.commons.dict.wordnet.indexbyname.instance.r.a.g;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceRAG {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"rag\", \"synsetCount\":5, \"upperType\":\"NOUN\", \"ids\":[\"00515669\", \"06278546\", \"07074884\", \"15195833\", \"04053034\"]}");
	add("{\"term\":\"rag day\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15196055\"]}");
	add("{\"term\":\"rag doll\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04053265\"]}");
	add("{\"term\":\"rag gourd\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12186941\"]}");
	add("{\"term\":\"rag paper\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14718833\"]}");
	add("{\"term\":\"rag trade\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08083153\"]}");
	add("{\"term\":\"rag week\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15195833\"]}");
	...
	add("{\"term\":\"ragged orchid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12087694\"]}");
	add("{\"term\":\"ragged orchis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12087694\"]}");
	add("{\"term\":\"ragged robin\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11832175\"]}");
	...
	add("{\"term\":\"raglan sleeve\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04053493\"]}");
	add("{\"term\":\"ragnar anton kittil frisch\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11003003\"]}");
	add("{\"term\":\"ragnar frisch\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11003003\"]}");
	...
	add("{\"term\":\"ragtag and bobtail\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08418776\"]}");
	...
	add("{\"term\":\"ragweed pollen\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14609572\"]}");
