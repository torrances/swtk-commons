package org.swtk.commons.dict.wordnet.indexbyname.instance.w.a.g;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceWAG {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"wag\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"00348478\", \"10782010\"]}");
	...
	add("{\"term\":\"wage claim\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07207505\"]}");
	add("{\"term\":\"wage concession\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07231920\"]}");
	add("{\"term\":\"wage earner\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10061695\"]}");
	add("{\"term\":\"wage floor\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06671186\"]}");
	add("{\"term\":\"wage freeze\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00811034\"]}");
	add("{\"term\":\"wage hike\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05117485\"]}");
	add("{\"term\":\"wage increase\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05117485\"]}");
	add("{\"term\":\"wage scale\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13875743\"]}");
	add("{\"term\":\"wage schedule\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13875743\"]}");
	add("{\"term\":\"wage setter\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14518178\"]}");
	...
	add("{\"term\":\"wagga wagga\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08852516\"]}");
	...
	add("{\"term\":\"wagon tire\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04550922\"]}");
	add("{\"term\":\"wagon train\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08444586\"]}");
	add("{\"term\":\"wagon wheel\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04551058\"]}");
