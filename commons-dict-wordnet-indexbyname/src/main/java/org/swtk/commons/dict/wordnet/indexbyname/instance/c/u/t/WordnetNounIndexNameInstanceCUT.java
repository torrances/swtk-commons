package org.swtk.commons.dict.wordnet.indexbyname.instance.c.u.t;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceCUT {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"cut\", \"synsetCount\":20, \"upperType\":\"NOUN\", \"ids\":[\"00068074\", \"00353157\", \"00360064\", \"00387723\", \"00388465\", \"00490486\", \"00566846\", \"00572481\", \"01228486\", \"03157409\", \"05758945\", \"06439886\", \"06625218\", \"06734210\", \"07669003\", \"14310615\", \"14453311\", \"03157285\", \"06630741\", \"13310182\"]}");
	add("{\"term\":\"cut glass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03157811\"]}");
	add("{\"term\":\"cut of beef\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07671686\"]}");
	add("{\"term\":\"cut of lamb\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07683071\"]}");
	add("{\"term\":\"cut of meat\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07669003\"]}");
	add("{\"term\":\"cut of mutton\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07682787\"]}");
	add("{\"term\":\"cut of pork\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07684647\"]}");
	add("{\"term\":\"cut of veal\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07681340\"]}");
	add("{\"term\":\"cut price\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05154484\"]}");
	add("{\"term\":\"cut rate\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05154484\"]}");
	add("{\"term\":\"cutaneous anthrax\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14096107\"]}");
	add("{\"term\":\"cutaneous leishmaniasis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14204669\"]}");
	add("{\"term\":\"cutaneous sensation\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05731155\"]}");
	add("{\"term\":\"cutaneous senses\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05662964\"]}");
	add("{\"term\":\"cutaneous vein\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05372453\"]}");
	add("{\"term\":\"cutaway\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"03157496\", \"03157617\"]}");
	add("{\"term\":\"cutaway drawing\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03157617\"]}");
	add("{\"term\":\"cutaway model\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03157617\"]}");
	...
	add("{\"term\":\"cutleaved coneflower\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12029218\"]}");
	...
	add("{\"term\":\"cutoff saw\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03141155\"]}");
	...
	add("{\"term\":\"cutting angle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13915458\"]}");
	add("{\"term\":\"cutting board\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03029196\"]}");
	add("{\"term\":\"cutting edge\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"03629706\", \"06219154\"]}");
	add("{\"term\":\"cutting implement\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03159112\"]}");
	add("{\"term\":\"cutting off\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"00360064\", \"00393517\"]}");
	add("{\"term\":\"cutting out\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00394177\"]}");
	add("{\"term\":\"cutting room\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03159282\"]}");
	add("{\"term\":\"cutting tool\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03158739\"]}");
	add("{\"term\":\"cuttle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01975182\"]}");
	add("{\"term\":\"cuttlefish\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01975182\"]}");
	add("{\"term\":\"cutty stool\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03159411\"]}");
