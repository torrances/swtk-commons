package org.swtk.commons.dict.wordnet.indexbyname.instance.f.u.m;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceFUM {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"fumaria\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11929822\"]}");
	add("{\"term\":\"fumaria claviculata\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11924743\"]}");
	add("{\"term\":\"fumaria fungosa\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11930333\"]}");
	add("{\"term\":\"fumaria officinalis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11929996\"]}");
	add("{\"term\":\"fumaria sempervirens\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11924946\"]}");
	add("{\"term\":\"fumariaceae\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11929517\"]}");
	add("{\"term\":\"fumaric acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14900217\"]}");
	...
	add("{\"term\":\"fumed oak\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12289616\"]}");
	...
	add("{\"term\":\"fumimaro konoe\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11128757\"]}");
	add("{\"term\":\"fumimaro konoye\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11128757\"]}");
	add("{\"term\":\"fumitory\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11929996\"]}");
	add("{\"term\":\"fumitory family\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11929517\"]}");
