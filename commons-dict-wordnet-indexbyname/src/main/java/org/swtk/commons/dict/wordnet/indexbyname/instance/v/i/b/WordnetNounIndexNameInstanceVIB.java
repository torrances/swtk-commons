package org.swtk.commons.dict.wordnet.indexbyname.instance.v.i.b;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceVIB {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"vibe\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04735141\"]}");
	add("{\"term\":\"vibes\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04540126\"]}");
	add("{\"term\":\"vibist\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10769596\"]}");
	add("{\"term\":\"viborg\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08780213\"]}");
	add("{\"term\":\"vibraharp\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04540126\"]}");
