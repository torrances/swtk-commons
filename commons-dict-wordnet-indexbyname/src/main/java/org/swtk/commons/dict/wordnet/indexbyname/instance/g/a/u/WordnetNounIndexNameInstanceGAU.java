package org.swtk.commons.dict.wordnet.indexbyname.instance.g.a.u;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceGAU {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"gaucheness\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04922298\"]}");
	...
	add("{\"term\":\"gaudi i cornet\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11012332\"]}");
	...
	add("{\"term\":\"gauffering iron\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03448699\"]}");
	add("{\"term\":\"gauge\", \"synsetCount\":5, \"upperType\":\"NOUN\", \"ids\":[\"05110583\", \"05110730\", \"05137293\", \"13876298\", \"03434198\"]}");
	add("{\"term\":\"gauge boson\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09310321\"]}");
	...
	add("{\"term\":\"gaultheria hispidula\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12255996\"]}");
	add("{\"term\":\"gaultheria procumbens\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12256282\"]}");
	add("{\"term\":\"gaultheria shallon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12256677\"]}");
	...
	add("{\"term\":\"gaussian curve\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06035496\"]}");
	add("{\"term\":\"gaussian distribution\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06035097\"]}");
	add("{\"term\":\"gaussian shape\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06035496\"]}");
	add("{\"term\":\"gaussmeter\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03714382\"]}");
	add("{\"term\":\"gautama\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09555346\"]}");
	add("{\"term\":\"gautama buddha\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09555346\"]}");
	add("{\"term\":\"gautama siddhartha\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09555346\"]}");
	add("{\"term\":\"gauze\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"03434824\", \"03435001\"]}");
	add("{\"term\":\"gauze bandage\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03435001\"]}");
