package org.swtk.commons.dict.wordnet.indexbyname.instance.h.i.s;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceHIS {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"hispanic\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10649009\"]}");
	add("{\"term\":\"hispanic american\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10649009\"]}");
	add("{\"term\":\"hispaniola\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08769150\"]}");
	add("{\"term\":\"hispid pocket mouse\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02352209\"]}");
	...
	add("{\"term\":\"histamine blocker\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03527402\"]}");
	add("{\"term\":\"histamine headache\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14350948\"]}");
	...
	add("{\"term\":\"histiocytic leukaemia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14268208\"]}");
	add("{\"term\":\"histiocytic leukemia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14268208\"]}");
	...
	add("{\"term\":\"histocompatibility complex\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08023646\"]}");
	...
	add("{\"term\":\"historic period\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15278839\"]}");
	add("{\"term\":\"historical document\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06527480\"]}");
	add("{\"term\":\"historical linguistics\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06178766\"]}");
	add("{\"term\":\"historical paper\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06527480\"]}");
	add("{\"term\":\"historical present\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06340902\"]}");
	add("{\"term\":\"historical record\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06527480\"]}");
	add("{\"term\":\"historical school\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08292764\"]}");
	...
	add("{\"term\":\"history department\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08133709\"]}");
	add("{\"term\":\"history lesson\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00891907\"]}");
