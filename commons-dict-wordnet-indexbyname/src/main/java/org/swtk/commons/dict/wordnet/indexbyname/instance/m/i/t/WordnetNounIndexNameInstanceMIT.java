package org.swtk.commons.dict.wordnet.indexbyname.instance.m.i.t;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceMIT {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"mit\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03731459\"]}");
	...
	add("{\"term\":\"mitchella repens\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12689278\"]}");
	...
	add("{\"term\":\"mite box\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03989125\"]}");
	add("{\"term\":\"mitella\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12821087\"]}");
	add("{\"term\":\"mitella diphylla\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12821592\"]}");
	add("{\"term\":\"mitella pentandra\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12821832\"]}");
	add("{\"term\":\"miter\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"03779503\", \"03779657\", \"03779994\"]}");
	add("{\"term\":\"miter box\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03779860\"]}");
	add("{\"term\":\"miter joint\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03779994\"]}");
	add("{\"term\":\"miter mushroom\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13056685\"]}");
	...
	add("{\"term\":\"mithridate mustard\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11919244\"]}");
	add("{\"term\":\"mithridates\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11203377\"]}");
	add("{\"term\":\"mithridates the great\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11203377\"]}");
	add("{\"term\":\"mithridates vi\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11203377\"]}");
	add("{\"term\":\"mitigating circumstance\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05831641\"]}");
	...
	add("{\"term\":\"mitral stenosis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14135397\"]}");
	add("{\"term\":\"mitral valve\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05401156\"]}");
	add("{\"term\":\"mitral valve prolapse\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14135197\"]}");
	add("{\"term\":\"mitral valve stenosis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14135397\"]}");
	add("{\"term\":\"mitre\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"03779503\", \"03779657\", \"03779994\"]}");
	add("{\"term\":\"mitre box\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03779860\"]}");
	add("{\"term\":\"mitre joint\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03779994\"]}");
	add("{\"term\":\"mitrewort\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12821346\"]}");
	add("{\"term\":\"mitrula elegans\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13049882\"]}");
