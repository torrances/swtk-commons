package org.swtk.commons.dict.wordnet.indexbyname.instance.m.o.h;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceMOH {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"mohair\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03784661\"]}");
	...
	add("{\"term\":\"mohammed ali\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11204263\"]}");
	add("{\"term\":\"mohammed reza pahlavi\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11240451\"]}");
	add("{\"term\":\"mohammed reza pahlevi\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11240451\"]}");
	add("{\"term\":\"mohammedan\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10346668\"]}");
	add("{\"term\":\"mohammedan calendar\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15203888\"]}");
	add("{\"term\":\"mohammedanism\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06244979\"]}");
	add("{\"term\":\"mohandas karamchand gandhi\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11009335\"]}");
	...
	add("{\"term\":\"mohave desert\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09193893\"]}");
	add("{\"term\":\"mohawk\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"05268427\", \"06929089\", \"09681436\"]}");
	add("{\"term\":\"mohawk haircut\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05268427\"]}");
	add("{\"term\":\"mohawk river\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09379826\"]}");
	...
	add("{\"term\":\"mohorovicic discontinuity\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09379977\"]}");
	add("{\"term\":\"mohria\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12977551\"]}");
	add("{\"term\":\"mohria caffrorum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12977682\"]}");
	add("{\"term\":\"mohs scale\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13873874\"]}");
