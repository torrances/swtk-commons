package org.swtk.commons.dict.wordnet.indexbyname.instance.a.l.o;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceALO {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"alocasia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11802505\"]}");
	add("{\"term\":\"alocasia macrorrhiza\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11802735\"]}");
	add("{\"term\":\"aloe\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12457182\"]}");
	add("{\"term\":\"aloe family\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12456765\"]}");
	add("{\"term\":\"aloe ferox\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12457412\"]}");
	add("{\"term\":\"aloe vera\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12457552\"]}");
	...
	add("{\"term\":\"aloha state\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09100742\"]}");
	add("{\"term\":\"alois senefelder\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11312652\"]}");
	...
	add("{\"term\":\"alopecia areata\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14481078\"]}");
	add("{\"term\":\"alopecurus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12128006\"]}");
	add("{\"term\":\"alopecurus pratensis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12128227\"]}");
	add("{\"term\":\"alopex\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02122613\"]}");
	add("{\"term\":\"alopex lagopus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02122731\"]}");
	add("{\"term\":\"alopiidae\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01488314\"]}");
	add("{\"term\":\"alopius\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01488442\"]}");
	add("{\"term\":\"alopius vulpinus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01488651\"]}");
	add("{\"term\":\"alosa\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02532925\"]}");
	add("{\"term\":\"alosa alosa\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02533630\"]}");
	add("{\"term\":\"alosa chrysocloris\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02533462\"]}");
	add("{\"term\":\"alosa pseudoharengus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02533745\"]}");
	add("{\"term\":\"alosa sapidissima\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02533268\"]}");
	add("{\"term\":\"alouatta\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02495167\"]}");
	add("{\"term\":\"aloys senefelder\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11312652\"]}");
