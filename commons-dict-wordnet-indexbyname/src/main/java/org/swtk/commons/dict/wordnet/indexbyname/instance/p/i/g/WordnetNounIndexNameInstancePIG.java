package org.swtk.commons.dict.wordnet.indexbyname.instance.p.i.g;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstancePIG {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"pig\", \"synsetCount\":6, \"upperType\":\"NOUN\", \"ids\":[\"03941274\", \"03941392\", \"09898610\", \"10199280\", \"10631726\", \"02398058\"]}");
	add("{\"term\":\"pig bed\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03941392\"]}");
	add("{\"term\":\"pig farm\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03941510\"]}");
	add("{\"term\":\"pig iron\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15008050\"]}");
	add("{\"term\":\"pig laurel\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12258590\"]}");
	add("{\"term\":\"pig lead\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15008253\"]}");
	add("{\"term\":\"pigboat\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04354832\"]}");
	add("{\"term\":\"pigeon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01814550\"]}");
	add("{\"term\":\"pigeon berry\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11876022\"]}");
	add("{\"term\":\"pigeon breast\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14238681\"]}");
	add("{\"term\":\"pigeon droppings\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14878915\"]}");
	add("{\"term\":\"pigeon guillemot\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02049699\"]}");
	add("{\"term\":\"pigeon hawk\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01614916\"]}");
	add("{\"term\":\"pigeon loft\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03691689\"]}");
	add("{\"term\":\"pigeon pea\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"07742206\", \"12531279\"]}");
	add("{\"term\":\"pigeon toes\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14583707\"]}");
	...
	add("{\"term\":\"piggy bank\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03941611\"]}");
	add("{\"term\":\"piggyback\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00320339\"]}");
	add("{\"term\":\"piggyback plant\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12825112\"]}");
	...
	add("{\"term\":\"pigmy talinum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11883936\"]}");
	add("{\"term\":\"pignolia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07790818\"]}");
	add("{\"term\":\"pignut\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12341144\"]}");
	add("{\"term\":\"pignut hickory\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12341144\"]}");
	add("{\"term\":\"pigpen\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04353506\"]}");
	add("{\"term\":\"pigs in blankets\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07889324\"]}");
