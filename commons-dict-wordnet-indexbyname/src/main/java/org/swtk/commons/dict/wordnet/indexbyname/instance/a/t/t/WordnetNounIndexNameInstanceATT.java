package org.swtk.commons.dict.wordnet.indexbyname.instance.a.t.t;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceATT {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"attacapa\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06920343\"]}");
	...
	add("{\"term\":\"attache case\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02758145\"]}");
	...
	add("{\"term\":\"attack aircraft\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03339975\"]}");
	add("{\"term\":\"attack aircraft carrier\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02690031\"]}");
	add("{\"term\":\"attack dog\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02106836\"]}");
	add("{\"term\":\"attack submarine\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02758534\"]}");
	...
	add("{\"term\":\"attalea funifera\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12605898\"]}");
	add("{\"term\":\"attar\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14917140\"]}");
	add("{\"term\":\"attar of roses\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14917279\"]}");
	...
	add("{\"term\":\"attendance check\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01014199\"]}");
	...
	add("{\"term\":\"attention deficit disorder\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14079762\"]}");
	add("{\"term\":\"attention deficit hyperactivity disorder\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14079762\"]}");
	add("{\"term\":\"attention span\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05710549\"]}");
	...
	add("{\"term\":\"attestation report\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00579191\"]}");
	add("{\"term\":\"attestation service\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00579191\"]}");
	...
	add("{\"term\":\"attic fan\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02758989\"]}");
	add("{\"term\":\"attica\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08804135\"]}");
	add("{\"term\":\"atticus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02307619\"]}");
	add("{\"term\":\"atticus atlas\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02307737\"]}");
	add("{\"term\":\"attila\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10847282\"]}");
	add("{\"term\":\"attila the hun\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10847282\"]}");
	...
	add("{\"term\":\"attorney general\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"00601032\", \"10589873\", \"09842232\"]}");
	add("{\"term\":\"attorney general of the united states\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00601032\"]}");
	...
	add("{\"term\":\"attractive feature\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05859350\"]}");
	add("{\"term\":\"attractive force\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11446644\"]}");
	add("{\"term\":\"attractive nuisance\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05839381\"]}");
	...
	add("{\"term\":\"attributive genitive\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06322991\"]}");
	add("{\"term\":\"attributive genitive case\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06322991\"]}");
	add("{\"term\":\"attrition\", \"synsetCount\":5, \"upperType\":\"NOUN\", \"ids\":[\"00362621\", \"07371570\", \"07550088\", \"11480462\", \"13444788\"]}");
	add("{\"term\":\"attrition rate\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15301293\"]}");
