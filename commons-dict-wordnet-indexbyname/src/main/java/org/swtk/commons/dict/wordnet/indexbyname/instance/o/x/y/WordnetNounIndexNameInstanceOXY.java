package org.swtk.commons.dict.wordnet.indexbyname.instance.o.x.y;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceOXY {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"oxyacetylene\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14996743\"]}");
	add("{\"term\":\"oxyacetylene torch\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03874441\"]}");
	...
	add("{\"term\":\"oxybutyric acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14951589\"]}");
	...
	add("{\"term\":\"oxydendrum arboreum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12262926\"]}");
	add("{\"term\":\"oxygen\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14672278\"]}");
	add("{\"term\":\"oxygen acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14996918\"]}");
	add("{\"term\":\"oxygen debt\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14066217\"]}");
	add("{\"term\":\"oxygen deficit\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05121952\"]}");
	add("{\"term\":\"oxygen mask\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03874541\"]}");
	...
	add("{\"term\":\"oxylebius pictus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02651848\"]}");
	...
	add("{\"term\":\"oxytetracycline hydrochloride\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03875067\"]}");
	add("{\"term\":\"oxytocic\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03875363\"]}");
	add("{\"term\":\"oxytocic drug\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03875363\"]}");
	...
	add("{\"term\":\"oxytropis lambertii\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12575234\"]}");
	add("{\"term\":\"oxyura\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01852388\"]}");
	add("{\"term\":\"oxyura jamaicensis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01852504\"]}");
	add("{\"term\":\"oxyuranus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01753994\"]}");
	add("{\"term\":\"oxyuranus scutellatus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01754113\"]}");
