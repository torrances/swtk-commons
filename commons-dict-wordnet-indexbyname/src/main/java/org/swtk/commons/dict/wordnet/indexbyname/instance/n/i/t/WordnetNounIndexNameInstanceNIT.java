package org.swtk.commons.dict.wordnet.indexbyname.instance.n.i.t;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceNIT {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"nit\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"01463787\", \"13662502\"]}");
	...
	add("{\"term\":\"nitrate bacterium\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01377344\"]}");
	add("{\"term\":\"nitrazepam\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03831871\"]}");
	add("{\"term\":\"nitre\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14885506\"]}");
	add("{\"term\":\"nitric acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14790711\"]}");
	add("{\"term\":\"nitric bacteria\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01364977\"]}");
	add("{\"term\":\"nitric bacterium\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01377344\"]}");
	add("{\"term\":\"nitric oxide\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14791381\"]}");
	...
	add("{\"term\":\"nitrite bacterium\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01377487\"]}");
	add("{\"term\":\"nitro group\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15040439\"]}");
	...
	add("{\"term\":\"nitrogen balance\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14041342\"]}");
	add("{\"term\":\"nitrogen cycle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13543287\"]}");
	add("{\"term\":\"nitrogen dioxide\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14791266\"]}");
	add("{\"term\":\"nitrogen fixation\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13543508\"]}");
	add("{\"term\":\"nitrogen mustard\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14981788\"]}");
	add("{\"term\":\"nitrogen narcosis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05690037\"]}");
	add("{\"term\":\"nitrogen oxide\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14791069\"]}");
	add("{\"term\":\"nitrogen trichloride\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15041688\"]}");
	...
	add("{\"term\":\"nitrohydrochloric acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14791656\"]}");
	...
	add("{\"term\":\"nitrous acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14790904\"]}");
	add("{\"term\":\"nitrous bacteria\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01365264\"]}");
	add("{\"term\":\"nitrous bacterium\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01377487\"]}");
	add("{\"term\":\"nitrous oxide\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03832485\"]}");
	add("{\"term\":\"nitta tree\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11784094\"]}");
