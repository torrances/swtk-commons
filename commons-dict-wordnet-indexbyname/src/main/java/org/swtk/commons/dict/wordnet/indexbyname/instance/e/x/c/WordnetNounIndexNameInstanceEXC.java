package org.swtk.commons.dict.wordnet.indexbyname.instance.e.x.c;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceEXC {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"excalibur\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03306975\"]}");
	...
	add("{\"term\":\"exchange premium\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13345319\"]}");
	add("{\"term\":\"exchange rate\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13347642\"]}");
	add("{\"term\":\"exchange traded fund\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13380205\"]}");
	add("{\"term\":\"exchange transfusion\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00324592\"]}");
	...
	add("{\"term\":\"excise tax\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13337354\"]}");
	...
	add("{\"term\":\"excitable area\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05497292\"]}");
	...
	add("{\"term\":\"exclamation mark\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06856067\"]}");
	add("{\"term\":\"exclamation point\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06856067\"]}");
	add("{\"term\":\"exclusion\", \"synsetCount\":4, \"upperType\":\"NOUN\", \"ids\":[\"00207776\", \"05715216\", \"14437397\", \"13958260\"]}");
	add("{\"term\":\"exclusion principle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05895546\"]}");
	add("{\"term\":\"exclusionary rule\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06666819\"]}");
	add("{\"term\":\"exclusive\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06695928\"]}");
	add("{\"term\":\"exclusive right\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05186242\"]}");
	...
	add("{\"term\":\"excretory organ\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05340807\"]}");
	add("{\"term\":\"excretory product\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14878134\"]}");
	...
	add("{\"term\":\"excursion rate\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13347794\"]}");
