package org.swtk.commons.dict.wordnet.indexbyname.instance.l.o.o;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceLOO {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"loo\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04565764\"]}");
	...
	add("{\"term\":\"lookdown fish\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02581085\"]}");
	...
	add("{\"term\":\"looking at\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00878805\"]}");
	add("{\"term\":\"looking for\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00948248\"]}");
	add("{\"term\":\"looking glass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03694158\"]}");
	add("{\"term\":\"looking glass tree\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12220499\"]}");
	add("{\"term\":\"lookout\", \"synsetCount\":4, \"upperType\":\"NOUN\", \"ids\":[\"00883223\", \"03694269\", \"08614732\", \"10290913\"]}");
	add("{\"term\":\"lookout man\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10290913\"]}");
	add("{\"term\":\"lookout station\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03694269\"]}");
	...
	add("{\"term\":\"loony bin\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02823933\"]}");
	add("{\"term\":\"loony toons\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02678511\"]}");
	...
	add("{\"term\":\"loop gain\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05118548\"]}");
	add("{\"term\":\"loop knot\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03694896\"]}");
	add("{\"term\":\"loop topology\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05738669\"]}");
	...
	add("{\"term\":\"looping ill\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14297570\"]}");
	add("{\"term\":\"loos\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11158075\"]}");
	add("{\"term\":\"loose cannon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10291222\"]}");
	add("{\"term\":\"loose end\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00582922\"]}");
	add("{\"term\":\"loose sentence\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06296442\"]}");
	add("{\"term\":\"loose smut\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"13087739\", \"14307411\"]}");
	add("{\"term\":\"loose woman\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09792353\"]}");
	add("{\"term\":\"looseness\", \"synsetCount\":6, \"upperType\":\"NOUN\", \"ids\":[\"00749605\", \"04781750\", \"04784660\", \"04812175\", \"04892804\", \"14395318\"]}");
	add("{\"term\":\"looseness of the bowels\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14395318\"]}");
	...
	add("{\"term\":\"loosestrife family\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12348543\"]}");
