package org.swtk.commons.dict.wordnet.indexbyname.instance.h.o.a;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceHOA {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"hoactzin\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01812393\"]}");
	...
	add("{\"term\":\"hoagland howard carmichael\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10902598\"]}");
	add("{\"term\":\"hoagy\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07713570\"]}");
	add("{\"term\":\"hoagy carmichael\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10902598\"]}");
	add("{\"term\":\"hoar\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14939773\"]}");
	add("{\"term\":\"hoard\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13388085\"]}");
	add("{\"term\":\"hoarded wealth\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13391842\"]}");
	...
	add("{\"term\":\"hoary alison\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11894892\"]}");
	add("{\"term\":\"hoary alyssum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11894892\"]}");
	add("{\"term\":\"hoary golden bush\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11997402\"]}");
	add("{\"term\":\"hoary marmot\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02364358\"]}");
	add("{\"term\":\"hoary pea\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12593051\"]}");
	add("{\"term\":\"hoary plantain\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"12620422\", \"12621028\"]}");
	add("{\"term\":\"hoary puccoon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12841808\"]}");
	add("{\"term\":\"hoary willow\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12748924\"]}");
