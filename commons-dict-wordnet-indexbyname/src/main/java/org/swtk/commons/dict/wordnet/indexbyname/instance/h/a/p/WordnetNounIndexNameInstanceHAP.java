package org.swtk.commons.dict.wordnet.indexbyname.instance.h.a.p;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceHAP {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"hap\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07328877\"]}");
	add("{\"term\":\"hapax legomenon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06305365\"]}");
	...
	add("{\"term\":\"haplopappus acaulis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12039844\"]}");
	add("{\"term\":\"haplopappus phyllocephalus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11996783\"]}");
	add("{\"term\":\"haplopappus spinulosus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11996980\"]}");
	...
	add("{\"term\":\"happy chance\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07331456\"]}");
	add("{\"term\":\"happy event\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07335494\"]}");
	add("{\"term\":\"happy hour\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15253815\"]}");
	add("{\"term\":\"hapsburg\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08172201\"]}");
	add("{\"term\":\"haptic sensation\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05731155\"]}");
