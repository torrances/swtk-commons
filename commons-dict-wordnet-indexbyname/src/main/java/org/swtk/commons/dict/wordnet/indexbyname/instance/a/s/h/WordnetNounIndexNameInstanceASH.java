package org.swtk.commons.dict.wordnet.indexbyname.instance.a.s.h;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceASH {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"ash\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"12324438\", \"12323979\", \"14793339\"]}");
	add("{\"term\":\"ash bin\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02750182\"]}");
	add("{\"term\":\"ash cake\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07704010\"]}");
	add("{\"term\":\"ash can\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02750384\"]}");
	add("{\"term\":\"ash gray\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04969239\"]}");
	add("{\"term\":\"ash grey\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04969239\"]}");
	add("{\"term\":\"ash tree\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12323979\"]}");
	add("{\"term\":\"ash wednesday\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15220457\"]}");
	...
	add("{\"term\":\"ashcan school\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"02750384\", \"08292418\"]}");
	...
	add("{\"term\":\"ashley montagu\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11206346\"]}");
