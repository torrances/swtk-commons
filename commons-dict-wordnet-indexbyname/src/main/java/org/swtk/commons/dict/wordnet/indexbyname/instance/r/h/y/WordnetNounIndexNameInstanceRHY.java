package org.swtk.commons.dict.wordnet.indexbyname.instance.r.h.y;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceRHY {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"rhyacotriton\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01637984\"]}");
	add("{\"term\":\"rhyacotriton olympicus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01638121\"]}");
	add("{\"term\":\"rhyme\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"06393492\", \"07111327\"]}");
	add("{\"term\":\"rhyme royal\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07112497\"]}");
	add("{\"term\":\"rhymer\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10548068\"]}");
	add("{\"term\":\"rhymester\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10548068\"]}");
	add("{\"term\":\"rhyming slang\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07173927\"]}");
	...
	add("{\"term\":\"rhynchoelaps australis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01749926\"]}");
	...
	add("{\"term\":\"rhythm and blues\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07078355\"]}");
	add("{\"term\":\"rhythm and blues musician\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10548391\"]}");
	add("{\"term\":\"rhythm method\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00854775\"]}");
	add("{\"term\":\"rhythm method of birth control\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00854775\"]}");
	add("{\"term\":\"rhythm section\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08234478\"]}");
	add("{\"term\":\"rhythmic pattern\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07108561\"]}");
