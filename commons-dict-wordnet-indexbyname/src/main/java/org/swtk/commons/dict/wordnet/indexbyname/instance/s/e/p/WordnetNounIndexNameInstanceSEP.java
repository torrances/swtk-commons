package org.swtk.commons.dict.wordnet.indexbyname.instance.s.e.p;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceSEP {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"sep\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15237535\"]}");
	...
	add("{\"term\":\"separation energy\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11449171\"]}");
	...
	add("{\"term\":\"sephardic jew\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10599756\"]}");
	...
	add("{\"term\":\"sepoy mutiny\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01283647\"]}");
	...
	add("{\"term\":\"septal defect\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14492738\"]}");
	...
	add("{\"term\":\"september elm\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12429222\"]}");
	add("{\"term\":\"september equinox\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15248546\"]}");
	...
	add("{\"term\":\"septic sore throat\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14208468\"]}");
	add("{\"term\":\"septic tank\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04180107\"]}");
	...
	add("{\"term\":\"septicemic plague\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14163441\"]}");
	...
	add("{\"term\":\"septobasidium pseudopedicellatum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13090533\"]}");
	...
	add("{\"term\":\"septuagesima sunday\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15217107\"]}");
