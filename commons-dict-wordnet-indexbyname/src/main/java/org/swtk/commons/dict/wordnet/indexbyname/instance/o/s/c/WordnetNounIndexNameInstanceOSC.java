package org.swtk.commons.dict.wordnet.indexbyname.instance.o.s.c;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceOSC {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"os capitatum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05280722\"]}");
	add("{\"term\":\"oscan\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"06975090\", \"09737185\"]}");
	add("{\"term\":\"oscar\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07283672\"]}");
	add("{\"term\":\"oscar hammerstein\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11046593\"]}");
	add("{\"term\":\"oscar hammerstein ii\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11046593\"]}");
	add("{\"term\":\"oscar palmer robertson\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11284818\"]}");
	add("{\"term\":\"oscar robertson\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11284818\"]}");
	add("{\"term\":\"oscar wilde\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11406341\"]}");
	...
	add("{\"term\":\"oscine bird\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01528361\"]}");
	...
	add("{\"term\":\"osculating circle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05110189\"]}");
