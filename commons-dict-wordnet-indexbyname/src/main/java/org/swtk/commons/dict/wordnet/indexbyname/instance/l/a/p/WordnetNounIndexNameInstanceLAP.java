package org.swtk.commons.dict.wordnet.indexbyname.instance.l.a.p;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceLAP {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"la paz\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08872300\"]}");
	add("{\"term\":\"la plata\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09433436\"]}");
	add("{\"term\":\"lap\", \"synsetCount\":6, \"upperType\":\"NOUN\", \"ids\":[\"00151411\", \"00296016\", \"03647020\", \"03647261\", \"14538643\", \"05570228\"]}");
	add("{\"term\":\"lap choly\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00670505\"]}");
	add("{\"term\":\"lap covering\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03647261\"]}");
	add("{\"term\":\"lap joint\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03647887\"]}");
	add("{\"term\":\"lap of honour\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00296389\"]}");
	add("{\"term\":\"lap of luxury\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14515700\"]}");
	add("{\"term\":\"lap of the gods\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14538779\"]}");
	...
	add("{\"term\":\"laparoscopic cholecystectomy\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00670505\"]}");
	...
	add("{\"term\":\"lapis lazuli\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14953935\"]}");
	...
	add("{\"term\":\"laportea canadensis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12414635\"]}");
	...
	add("{\"term\":\"lappet caterpillar\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02310685\"]}");
	add("{\"term\":\"lappet moth\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02310562\"]}");
	...
	add("{\"term\":\"laptev sea\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09358958\"]}");
	add("{\"term\":\"laptop\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03648120\"]}");
	add("{\"term\":\"laptop computer\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03648120\"]}");
