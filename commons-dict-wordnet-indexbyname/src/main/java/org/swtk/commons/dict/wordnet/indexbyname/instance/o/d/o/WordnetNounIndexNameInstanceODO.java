package org.swtk.commons.dict.wordnet.indexbyname.instance.o.d.o;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceODO {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"odo\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11376631\"]}");
	add("{\"term\":\"odo of lagery\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11376631\"]}");
	...
	add("{\"term\":\"odobenus divergens\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02084579\"]}");
	add("{\"term\":\"odobenus rosmarus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02084450\"]}");
	add("{\"term\":\"odocoileus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02434785\"]}");
	add("{\"term\":\"odocoileus hemionus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02435157\"]}");
	add("{\"term\":\"odocoileus hemionus columbianus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02435350\"]}");
	add("{\"term\":\"odocoileus virginianus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02434937\"]}");
	...
	add("{\"term\":\"odontaspis taurus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01490147\"]}");
	...
	add("{\"term\":\"odontoid process\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05596641\"]}");
