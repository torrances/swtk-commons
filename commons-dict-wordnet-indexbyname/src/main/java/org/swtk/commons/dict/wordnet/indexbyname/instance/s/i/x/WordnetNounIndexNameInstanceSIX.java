package org.swtk.commons.dict.wordnet.indexbyname.instance.s.i.x;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceSIX {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"six\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"04232479\", \"13766862\"]}");
	add("{\"term\":\"six day war\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01304940\"]}");
	add("{\"term\":\"six nations\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08322207\"]}");
	add("{\"term\":\"six pack\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04232284\"]}");
	...
	add("{\"term\":\"sixpenny nail\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04232399\"]}");
	add("{\"term\":\"sixsome\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08004131\"]}");
	add("{\"term\":\"sixteen\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13769746\"]}");
	add("{\"term\":\"sixteen personality factor questionnaire\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06487604\"]}");
	add("{\"term\":\"sixteenth\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"13760725\", \"13870663\"]}");
	add("{\"term\":\"sixteenth note\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06884584\"]}");
	add("{\"term\":\"sixteenth part\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13760725\"]}");
	add("{\"term\":\"sixth\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"06872975\", \"13760092\", \"13869599\"]}");
	add("{\"term\":\"sixth baron byron of rochdale\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10897005\"]}");
	add("{\"term\":\"sixth cranial nerve\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05486760\"]}");
	add("{\"term\":\"sixth crusade\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00972183\"]}");
	add("{\"term\":\"sixth sense\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05716154\"]}");
	...
	add("{\"term\":\"sixtus iv\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11324134\"]}");
