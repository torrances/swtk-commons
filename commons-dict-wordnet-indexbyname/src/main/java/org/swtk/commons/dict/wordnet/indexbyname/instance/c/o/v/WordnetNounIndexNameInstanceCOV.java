package org.swtk.commons.dict.wordnet.indexbyname.instance.c.o.v;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceCOV {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"covalence\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05041916\"]}");
	...
	add("{\"term\":\"covalent bond\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11456862\"]}");
	...
	add("{\"term\":\"cover charge\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13339433\"]}");
	add("{\"term\":\"cover crop\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13107198\"]}");
	add("{\"term\":\"cover girl\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09991988\"]}");
	add("{\"term\":\"cover glass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03127224\"]}");
	add("{\"term\":\"cover letter\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06637323\"]}");
	add("{\"term\":\"cover plate\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03128317\"]}");
	add("{\"term\":\"cover slip\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03127224\"]}");
	add("{\"term\":\"cover song\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03126349\"]}");
	add("{\"term\":\"cover version\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03126349\"]}");
	...
	add("{\"term\":\"covered bridge\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03126724\"]}");
	add("{\"term\":\"covered couch\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03126853\"]}");
	add("{\"term\":\"covered option\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00081439\"]}");
	add("{\"term\":\"covered smut\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13087208\"]}");
	add("{\"term\":\"covered stadium\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03225395\"]}");
	add("{\"term\":\"covered stand\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03457897\"]}");
	add("{\"term\":\"covered wagon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03126946\"]}");
	add("{\"term\":\"covering\", \"synsetCount\":5, \"upperType\":\"NOUN\", \"ids\":[\"00713478\", \"00829743\", \"01051609\", \"03127399\", \"09280855\"]}");
	add("{\"term\":\"covering fire\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00990979\"]}");
	add("{\"term\":\"covering letter\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06637323\"]}");
	add("{\"term\":\"covering material\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14849232\"]}");
	...
	add("{\"term\":\"covert operation\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00986281\"]}");
