package org.swtk.commons.dict.wordnet.indexbyname.instance.r.i.b;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceRIB {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"rib\", \"synsetCount\":6, \"upperType\":\"NOUN\", \"ids\":[\"04094402\", \"05243209\", \"06780484\", \"07672350\", \"05286525\", \"04094238\"]}");
	add("{\"term\":\"rib cage\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05561401\"]}");
	add("{\"term\":\"rib joint pliers\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04095455\"]}");
	add("{\"term\":\"rib roast\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07677695\"]}");
	...
	add("{\"term\":\"ribbed toad\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01647541\"]}");
	add("{\"term\":\"ribbed vault\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04094821\"]}");
	...
	add("{\"term\":\"ribbon development\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04095341\"]}");
	add("{\"term\":\"ribbon fern\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"12981312\", \"13200702\", \"13235383\"]}");
	add("{\"term\":\"ribbon grass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12150255\"]}");
	add("{\"term\":\"ribbon snake\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01738218\"]}");
	add("{\"term\":\"ribbon tree\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12205771\"]}");
	add("{\"term\":\"ribbon worm\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01931158\"]}");
	...
	add("{\"term\":\"ribes grossularia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12826775\"]}");
	add("{\"term\":\"ribes nigrum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12826321\"]}");
	add("{\"term\":\"ribes rubrum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12826133\"]}");
	add("{\"term\":\"ribes sanguineum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12826659\"]}");
	add("{\"term\":\"ribes sativum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12826522\"]}");
	...
	add("{\"term\":\"ribonucleic acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14856363\"]}");
