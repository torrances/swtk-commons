package org.swtk.commons.dict.wordnet.indexbyname.instance.c.u.m;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceCUM {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"cum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05411679\"]}");
	...
	add("{\"term\":\"cumberland gap\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284313\"]}");
	add("{\"term\":\"cumberland mountains\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284510\"]}");
	add("{\"term\":\"cumberland plateau\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284510\"]}");
	add("{\"term\":\"cumberland river\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284044\"]}");
	...
	add("{\"term\":\"cumin seed\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07830610\"]}");
	add("{\"term\":\"cuminum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12957473\"]}");
	add("{\"term\":\"cuminum cyminum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12957586\"]}");
	...
	add("{\"term\":\"cumulative preferred\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13357219\"]}");
	add("{\"term\":\"cumulative preferred stock\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13357219\"]}");
	add("{\"term\":\"cumulative vote\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00184984\"]}");
	add("{\"term\":\"cumulonimbus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284678\"]}");
	add("{\"term\":\"cumulonimbus cloud\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284678\"]}");
	add("{\"term\":\"cumulus\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"07978094\", \"09284866\"]}");
	add("{\"term\":\"cumulus cloud\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09284866\"]}");
