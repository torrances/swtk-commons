package org.swtk.commons.dict.wordnet.indexbyname.instance.a.c.i;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceACI {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"acicula\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09209933\"]}");
	...
	add("{\"term\":\"acid anhydrides\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14832787\"]}");
	add("{\"term\":\"acid dye\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14778557\"]}");
	add("{\"term\":\"acid halide\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14832922\"]}");
	add("{\"term\":\"acid head\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09782695\"]}");
	add("{\"term\":\"acid hydrogen\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14665068\"]}");
	add("{\"term\":\"acid precipitation\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14541231\"]}");
	add("{\"term\":\"acid rain\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14541231\"]}");
	add("{\"term\":\"acid rock\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07079602\"]}");
	add("{\"term\":\"acid test\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05755440\"]}");
	add("{\"term\":\"acid value\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13602801\"]}");
	add("{\"term\":\"acidemia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14044224\"]}");
	add("{\"term\":\"acidic hydrogen\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14665068\"]}");
	...
	add("{\"term\":\"acidophilus milk\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07861547\"]}");
	...
	add("{\"term\":\"acinonyx jubatus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02132960\"]}");
	add("{\"term\":\"acinos\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12860169\"]}");
	add("{\"term\":\"acinos arvensis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12860334\"]}");
	...
	add("{\"term\":\"acipenser huso\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02643487\"]}");
	add("{\"term\":\"acipenser transmontanus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02643256\"]}");
