package org.swtk.commons.dict.wordnet.indexbyname.instance.e.p.h;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceEPH {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"epha\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13638068\"]}");
	add("{\"term\":\"ephah\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13638068\"]}");
	add("{\"term\":\"ephedra\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11619137\"]}");
	add("{\"term\":\"ephedra sinica\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11619337\"]}");
	...
	add("{\"term\":\"ephemeris time\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15181706\"]}");
	...
	add("{\"term\":\"ephestia elutella\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02292992\"]}");
	add("{\"term\":\"ephesus\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"08330913\", \"08806178\"]}");
	add("{\"term\":\"ephippidae\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02607287\"]}");
	add("{\"term\":\"ephippiorhynchus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02006648\"]}");
	add("{\"term\":\"ephippiorhynchus senegalensis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02006785\"]}");
