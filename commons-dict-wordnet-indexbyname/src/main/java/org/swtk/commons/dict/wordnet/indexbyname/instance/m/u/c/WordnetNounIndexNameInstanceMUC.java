package org.swtk.commons.dict.wordnet.indexbyname.instance.m.u.c;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceMUC {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"much\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13798833\"]}");
	...
	add("{\"term\":\"mucic acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14640149\"]}");
	...
	add("{\"term\":\"mucocutaneous leishmaniasis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14204891\"]}");
	add("{\"term\":\"mucocutaneous lymph node syndrome\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14099752\"]}");
	...
	add("{\"term\":\"mucous colitis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14329672\"]}");
	add("{\"term\":\"mucous membrane\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05334682\"]}");
	add("{\"term\":\"mucous secretion\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05422738\"]}");
	...
	add("{\"term\":\"mucuna aterrima\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12570913\"]}");
	add("{\"term\":\"mucuna deeringiana\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12570913\"]}");
	add("{\"term\":\"mucuna pruriens utilis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12570913\"]}");
