package org.swtk.commons.dict.wordnet.indexbyname.instance.n.a.u;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceNAU {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"nauch\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00527830\"]}");
	...
	add("{\"term\":\"nauclea diderrichii\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12689678\"]}");
	add("{\"term\":\"naucrates\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02582686\"]}");
	add("{\"term\":\"naucrates ductor\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02582819\"]}");
	...
	add("{\"term\":\"nauru island\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08860201\"]}");
	...
	add("{\"term\":\"naut mi\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"13682449\", \"13682724\"]}");
	add("{\"term\":\"nautch\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00527830\"]}");
	add("{\"term\":\"nautch dance\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00527830\"]}");
	add("{\"term\":\"nautch girl\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10366935\"]}");
	add("{\"term\":\"nautical chain\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13682196\"]}");
	add("{\"term\":\"nautical linear unit\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13671244\"]}");
	add("{\"term\":\"nautical mile\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"13682449\", \"13682724\"]}");
	add("{\"term\":\"nautical signal flag\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06888442\"]}");
