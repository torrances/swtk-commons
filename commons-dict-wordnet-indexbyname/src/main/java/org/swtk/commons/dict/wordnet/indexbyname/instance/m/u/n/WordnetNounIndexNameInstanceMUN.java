package org.swtk.commons.dict.wordnet.indexbyname.instance.m.u.n;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceMUN {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"munch\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"00843054\", \"11216198\"]}");
	...
	add("{\"term\":\"munchausen syndrome\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14330702\"]}");
	...
	add("{\"term\":\"mung bean\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"07741018\", \"12598760\", \"12599160\"]}");
	add("{\"term\":\"mung bean plant\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12598760\"]}");
	add("{\"term\":\"munggo\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"07741018\", \"12599160\"]}");
	add("{\"term\":\"mungo park\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11242645\"]}");
	add("{\"term\":\"munich\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08792060\"]}");
	add("{\"term\":\"munich beer\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07903279\"]}");
	add("{\"term\":\"municipal bond\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13359672\"]}");
	add("{\"term\":\"municipal center\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08561059\"]}");
	add("{\"term\":\"municipal government\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08242657\"]}");
	add("{\"term\":\"municipal note\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13436216\"]}");
	...
	add("{\"term\":\"munitions industry\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08085760\"]}");
	...
	add("{\"term\":\"muntingia calabura\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12214664\"]}");
	add("{\"term\":\"muntjac\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02437585\"]}");
	add("{\"term\":\"muntz metal\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14744399\"]}");
