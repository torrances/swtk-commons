package org.swtk.commons.dict.wordnet.indexbyname.instance.a.b.d;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceABD {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"abdias\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"06451382\", \"11231226\"]}");
	...
	add("{\"term\":\"abdominal actinomycosis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14283241\"]}");
	add("{\"term\":\"abdominal aorta\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05344183\"]}");
	add("{\"term\":\"abdominal aortic aneurysm\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14129938\"]}");
	add("{\"term\":\"abdominal breathing\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00834957\"]}");
	add("{\"term\":\"abdominal cavity\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05565978\"]}");
	add("{\"term\":\"abdominal delivery\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00186627\"]}");
	add("{\"term\":\"abdominal external oblique muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05565472\"]}");
	add("{\"term\":\"abdominal muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05564972\"]}");
	add("{\"term\":\"abdominal nerve plexus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05516386\"]}");
	add("{\"term\":\"abdominal pregnancy\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14070922\"]}");
	add("{\"term\":\"abdominal wall\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05612189\"]}");
	...
	add("{\"term\":\"abducens muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05323957\"]}");
	add("{\"term\":\"abducens nerve\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05486760\"]}");
	add("{\"term\":\"abducent\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05486760\"]}");
	add("{\"term\":\"abducent nerve\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05486760\"]}");
	...
	add("{\"term\":\"abductor muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05298509\"]}");
