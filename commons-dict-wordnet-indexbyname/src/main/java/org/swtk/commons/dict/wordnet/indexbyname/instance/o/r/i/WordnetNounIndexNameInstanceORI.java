package org.swtk.commons.dict.wordnet.indexbyname.instance.o.r.i;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceORI {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"o ring\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03861124\"]}");
	add("{\"term\":\"oriel\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03860853\"]}");
	add("{\"term\":\"oriel window\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03860853\"]}");
	add("{\"term\":\"orient\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"08579780\", \"08580157\"]}");
	add("{\"term\":\"oriental alabaster\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14689648\"]}");
	add("{\"term\":\"oriental arborvitae\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11664913\"]}");
	add("{\"term\":\"oriental beetle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02176436\"]}");
	add("{\"term\":\"oriental bittersweet\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12769294\"]}");
	add("{\"term\":\"oriental black mushroom\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13022690\"]}");
	add("{\"term\":\"oriental bush cherry\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12667501\"]}");
	add("{\"term\":\"oriental cherry\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12670078\"]}");
	add("{\"term\":\"oriental cockroach\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02236595\"]}");
	add("{\"term\":\"oriental garlic\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12456282\"]}");
	add("{\"term\":\"oriental plane\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12828384\"]}");
	add("{\"term\":\"oriental poppy\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11922446\"]}");
	add("{\"term\":\"oriental roach\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02236595\"]}");
	add("{\"term\":\"oriental scops owl\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01626853\"]}");
	add("{\"term\":\"oriental sore\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14204669\"]}");
	add("{\"term\":\"oriental spruce\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11646860\"]}");
	add("{\"term\":\"oriental studies\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06167901\"]}");
	...
	add("{\"term\":\"orientation course\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00893192\"]}");
	...
	add("{\"term\":\"origanum dictamnus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12874466\"]}");
	add("{\"term\":\"origanum majorana\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12874242\"]}");
	add("{\"term\":\"origanum vulgare\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12874047\"]}");
	...
	add("{\"term\":\"original sin\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00758836\"]}");
	...
	add("{\"term\":\"oriolus oriolus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01578717\"]}");
	...
	add("{\"term\":\"orites excelsa\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12242607\"]}");
