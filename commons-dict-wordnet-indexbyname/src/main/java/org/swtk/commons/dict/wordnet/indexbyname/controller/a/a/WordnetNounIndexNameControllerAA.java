package org.swtk.commons.dict.wordnet.indexbyname.controller.a.a;

import java.util.Collection;
import java.util.Set;
import java.util.TreeSet;
import org.swtk.common.dict.dto.wordnet.IndexNoun;
import org.swtk.commons.dict.wordnet.indexbyname.instance.a.a.c.WordnetNounIndexNameInstanceAAC;
...
public final class WordnetNounIndexNameControllerAA {
	public static Collection<IndexNoun> get(final String TERM) throws BusinessException {
		String key = TERM.substring(0, 4).toLowerCase();
		if ("aac".equals(key)) return WordnetNounIndexNameInstanceAAC.get(TERM);
	...
	public static Collection<String> terms() throws BusinessException {
		...
		set.addAll(WordnetNounIndexNameInstanceAAC.terms());
