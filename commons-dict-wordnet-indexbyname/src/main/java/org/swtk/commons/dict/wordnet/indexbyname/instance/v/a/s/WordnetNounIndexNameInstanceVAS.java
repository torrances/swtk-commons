package org.swtk.commons.dict.wordnet.indexbyname.instance.v.a.s;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceVAS {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"vas\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05404676\"]}");
	add("{\"term\":\"vas deferens\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05533826\"]}");
	add("{\"term\":\"vasa brevis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05353739\"]}");
	add("{\"term\":\"vasa efferentia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05533621\"]}");
	add("{\"term\":\"vasa vasorum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05425929\"]}");
	add("{\"term\":\"vasarely\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11381137\"]}");
	add("{\"term\":\"vasari\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11381283\"]}");
	add("{\"term\":\"vasco da gamma\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10940334\"]}");
	add("{\"term\":\"vasco nunez de balboa\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10851456\"]}");
	add("{\"term\":\"vascular bundle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13118708\"]}");
	add("{\"term\":\"vascular hemophilia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14194658\"]}");
	add("{\"term\":\"vascular plant\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13104346\"]}");
	add("{\"term\":\"vascular ray\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13119274\"]}");
	add("{\"term\":\"vascular spider\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14271551\"]}");
	add("{\"term\":\"vascular strand\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13118708\"]}");
	add("{\"term\":\"vascular structure\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05404521\"]}");
	add("{\"term\":\"vascular system\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05518937\"]}");
	add("{\"term\":\"vascular tissue\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13117622\"]}");
	...
	add("{\"term\":\"vase vine\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11751402\"]}");
	add("{\"term\":\"vasectomy\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00717431\"]}");
	add("{\"term\":\"vaseline\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04529604\"]}");
	add("{\"term\":\"vaslav nijinsky\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11227575\"]}");
