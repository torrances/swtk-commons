package org.swtk.commons.dict.wordnet.indexbyname.instance.f.i.x;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceFIX {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"fix\", \"synsetCount\":5, \"upperType\":\"NOUN\", \"ids\":[\"00156307\", \"00215015\", \"00267650\", \"00324088\", \"14432893\"]}");
	...
	add("{\"term\":\"fixed charge\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13339169\"]}");
	add("{\"term\":\"fixed cost\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13339169\"]}");
	add("{\"term\":\"fixed costs\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13339169\"]}");
	add("{\"term\":\"fixed disk\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03497643\"]}");
	add("{\"term\":\"fixed intonation\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01257712\"]}");
	add("{\"term\":\"fixed investment trust\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13383907\"]}");
	add("{\"term\":\"fixed oil\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14991866\"]}");
	add("{\"term\":\"fixed phagocyte\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05458675\"]}");
	add("{\"term\":\"fixed star\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09303901\"]}");
	add("{\"term\":\"fixed storage\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04065351\"]}");
	...
	add("{\"term\":\"fixing agent\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14893478\"]}");
