package org.swtk.commons.dict.wordnet.indexbyname.instance.e.v.a;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceEVA {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"eva braun\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10883036\"]}");
	...
	add("{\"term\":\"evangelical and reformed church\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08108256\"]}");
	add("{\"term\":\"evangelical united brethren church\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08109821\"]}");
	...
	add("{\"term\":\"evangelista torricelli\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11366105\"]}");
	...
	add("{\"term\":\"evaporated milk\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07862335\"]}");
	add("{\"term\":\"evaporation\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"13481771\", \"13593639\"]}");
	add("{\"term\":\"evaporative cooler\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03306778\"]}");
	...
	add("{\"term\":\"evariste galois\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"11008257\"]}");
	add("{\"term\":\"evasion\", \"synsetCount\":4, \"upperType\":\"NOUN\", \"ids\":[\"00059947\", \"00742010\", \"01123176\", \"06773810\"]}");
	add("{\"term\":\"evasive action\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"00060372\"]}");
	add("{\"term\":\"evasive answer\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06572749\"]}");
