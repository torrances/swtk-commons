package org.swtk.commons.dict.wordnet.indexbyname.instance.p.u.d;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstancePUD {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"pud\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07628605\"]}");
	...
	add("{\"term\":\"pudding berry\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12969011\"]}");
	add("{\"term\":\"pudding face\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05609417\"]}");
	add("{\"term\":\"pudding head\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10686626\"]}");
	add("{\"term\":\"pudding pipe tree\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12512611\"]}");
	add("{\"term\":\"pudding stone\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14887182\"]}");
	...
	add("{\"term\":\"pudendal artery\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05361231\"]}");
	add("{\"term\":\"pudendal block\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14052645\"]}");
	add("{\"term\":\"pudendal cleavage\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05530435\"]}");
	add("{\"term\":\"pudendal cleft\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05530435\"]}");
	add("{\"term\":\"pudendal slit\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05530435\"]}");
	add("{\"term\":\"pudendal vein\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05385480\"]}");
