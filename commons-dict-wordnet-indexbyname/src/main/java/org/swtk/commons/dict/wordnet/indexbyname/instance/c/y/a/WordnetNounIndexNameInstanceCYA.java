package org.swtk.commons.dict.wordnet.indexbyname.instance.c.y.a;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceCYA {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"cyamopsis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12540728\"]}");
	add("{\"term\":\"cyamopsis psoraloides\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12540911\"]}");
	add("{\"term\":\"cyamopsis tetragonolobus\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12540911\"]}");
	...
	add("{\"term\":\"cyanic acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14850783\"]}");
	add("{\"term\":\"cyanide\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"14850937\", \"14851516\"]}");
	add("{\"term\":\"cyanide group\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14851361\"]}");
	add("{\"term\":\"cyanide poisoning\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14534250\"]}");
	add("{\"term\":\"cyanide process\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13475962\"]}");
	add("{\"term\":\"cyanide radical\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14851361\"]}");
	add("{\"term\":\"cyanine dye\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"15011709\"]}");
	add("{\"term\":\"cyanite\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14703745\"]}");
	add("{\"term\":\"cyano group\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14851361\"]}");
	add("{\"term\":\"cyano radical\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14851361\"]}");
	...
	add("{\"term\":\"cyanocitta cristata\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01583511\"]}");
	...
	add("{\"term\":\"cyanuric acid\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"14851850\"]}");
	add("{\"term\":\"cyathea\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13208065\"]}");
	add("{\"term\":\"cyathea medullaris\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13208265\"]}");
