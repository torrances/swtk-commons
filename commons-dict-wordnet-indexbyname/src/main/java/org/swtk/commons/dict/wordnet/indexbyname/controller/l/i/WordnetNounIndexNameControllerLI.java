package org.swtk.commons.dict.wordnet.indexbyname.controller.l.i;  import java.util.Collection; import java.util.Set; import java.util.TreeSet;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  	import org.swtk.commons.dict.wordnet.indexbyname.instance.l.i.a.WordnetNounIndexNameInstanceLIA;
  ...
  import com.trimc.blogger.commons.exception.BusinessException;  public final class WordnetNounIndexNameControllerLI {  	public static Collection<IndexNoun> get(final String TERM) throws BusinessException { 		if (TERM.length() < 3) throw new BusinessException("TERM not found (term = %s)", TERM); 		 		String key = TERM.replaceAll(" ", "").substring(0, 3).toLowerCase(); 			if ("lia".equals(key)) return WordnetNounIndexNameInstanceLIA.get(TERM);
