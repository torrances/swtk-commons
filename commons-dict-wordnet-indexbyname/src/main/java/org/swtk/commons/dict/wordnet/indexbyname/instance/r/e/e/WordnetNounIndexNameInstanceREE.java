package org.swtk.commons.dict.wordnet.indexbyname.instance.r.e.e;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceREE {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"reed\", \"synsetCount\":5, \"upperType\":\"NOUN\", \"ids\":[\"02820934\", \"04074000\", \"11276325\", \"11276484\", \"12157237\"]}");
	add("{\"term\":\"reed bunting\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01540700\"]}");
	add("{\"term\":\"reed canary grass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12150255\"]}");
	add("{\"term\":\"reed grass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12133435\"]}");
	add("{\"term\":\"reed instrument\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02820934\"]}");
	add("{\"term\":\"reed mace\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12176290\"]}");
	add("{\"term\":\"reed meadow grass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12142959\"]}");
	add("{\"term\":\"reed organ\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"03499638\"]}");
	add("{\"term\":\"reed pipe\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04074255\"]}");
	add("{\"term\":\"reed rhapis\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12617106\"]}");
	add("{\"term\":\"reed section\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08234786\"]}");
	add("{\"term\":\"reed stop\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04074343\"]}");
	...
	add("{\"term\":\"reef knot\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04074465\"]}");
	add("{\"term\":\"reef squirrelfish\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01453591\"]}");
	add("{\"term\":\"reef whitetip shark\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01495787\"]}");
	...
	add("{\"term\":\"reentering angle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13912757\"]}");
	add("{\"term\":\"reentering polygon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13889626\"]}");
	add("{\"term\":\"reentrant angle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13912757\"]}");
	add("{\"term\":\"reentrant polygon\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"13889626\"]}");
