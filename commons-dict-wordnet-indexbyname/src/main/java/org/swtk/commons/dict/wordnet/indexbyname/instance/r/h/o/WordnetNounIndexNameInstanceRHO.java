package org.swtk.commons.dict.wordnet.indexbyname.instance.r.h.o;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexNameInstanceRHO {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("{\"term\":\"rho\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"06848895\"]}");
	...
	add("{\"term\":\"rhodanthe manglesii\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12028235\"]}");
	add("{\"term\":\"rhode island\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"09160042\", \"09159733\"]}");
	add("{\"term\":\"rhode island bent\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12127519\"]}");
	add("{\"term\":\"rhode island red\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01796076\"]}");
	add("{\"term\":\"rhode islander\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09764769\"]}");
	add("{\"term\":\"rhodes\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"08801664\", \"11279044\"]}");
	add("{\"term\":\"rhodes grass\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12135107\"]}");
	add("{\"term\":\"rhodes scholar\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10547870\"]}");
	add("{\"term\":\"rhodesia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09189894\"]}");
	add("{\"term\":\"rhodesian man\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10547723\"]}");
	add("{\"term\":\"rhodesian ridgeback\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"02090046\"]}");
	...
	add("{\"term\":\"rhododendron californicum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12264975\"]}");
	add("{\"term\":\"rhododendron maxima\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12265167\"]}");
	add("{\"term\":\"rhododendron viscosum\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12265336\"]}");
	...
	add("{\"term\":\"rhodope mountains\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09431673\"]}");
	...
	add("{\"term\":\"rhodosphaera rhodanthema\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"12783165\"]}");
	add("{\"term\":\"rhodymenia\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01417627\"]}");
	add("{\"term\":\"rhodymenia palmata\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"01417780\"]}");
	...
	add("{\"term\":\"rhomboid minor muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05583005\"]}");
	add("{\"term\":\"rhomboid muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05582633\"]}");
	add("{\"term\":\"rhomboideus major muscle\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"05582816\"]}");
	...
	add("{\"term\":\"rhone river\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09431855\"]}");
	add("{\"term\":\"rhone wine\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"07913725\"]}");
