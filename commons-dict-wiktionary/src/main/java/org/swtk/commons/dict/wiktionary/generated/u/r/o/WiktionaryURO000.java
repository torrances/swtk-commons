package org.swtk.commons.dict.wiktionary.generated.u.r.o;  import java.util.HashMap; import java.util.Map;  import org.swtk.common.dict.dto.wiktionary.Entry;  import com.trimc.blogger.commons.utils.GsonUtils;  public class WiktionaryURO000 {  	private static Map<String, Entry> map = new HashMap<String, Entry>();  	static { 			add("urobilin", "{\"term\":\"urobilin\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"A yellow linear tetrapyrrole resulting from the breakdown of heme, produced when urobilinogen is oxidized by intestinal bacteria\", \"priority\":1}]}, \"synonyms\":{}}");
