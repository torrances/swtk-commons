package org.swtk.commons.dict.wiktionary.generated.c.y.t;  import java.util.HashMap; import java.util.Map;  import org.swtk.common.dict.dto.wiktionary.Entry;  import com.trimc.blogger.commons.utils.GsonUtils;  public class WiktionaryCYT000 {  	private static Map<String, Entry> map = new HashMap<String, Entry>();  	static { 			add("cytarabine", "{\"term\":\"cytarabine\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"Short for \u0027cytosine arabinoside\u0027.\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"A particular drug used in chemotherapy\", \"priority\":1}]}, \"synonyms\":{}}");
	...
	add("cytogenesis", "{\"term\":\"cytogenesis\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"{{confix|cyto|genesis|lang\u003den}}\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"The formation, development and variation of cells\", \"priority\":1}]}, \"synonyms\":{}}");

	add("cytokinesis", "{\"term\":\"cytokinesis\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"{{confix|cyto|kinesis|lang\u003den}}\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"The process in which the cytoplasm of a cell divides following the division of the nucleus\", \"priority\":1}]}, \"synonyms\":{}}");

	add("cytokinetics", "{\"term\":\"cytokinetics\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"{{prefix|cyto|kinetics|lang\u003den}}\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"The study of cytokinesis\", \"priority\":1}]}, \"synonyms\":{}}");

	add("cytology", "{\"term\":\"cytology\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"{{confix|cyto|gloss1\u003dcell|logy|lang\u003den}}\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"The study of cells\", \"priority\":1},{\"upperType\":\"NOUN\", \"text\":\"Cytopathology\", \"priority\":2}]}, \"synonyms\":{}}");
