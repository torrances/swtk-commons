package org.swtk.commons.dict.wiktionary.controller;  import org.swtk.common.dict.dto.wiktionary.Entry;  import org.swtk.commons.dict.wiktionary.generated.l.a.a.*;
...
import org.swtk.commons.dict.wiktionary.generated.l.y.s.*;   public final class WiktionaryDbL {  	public static Entry findByName(String name) { 		if (name.length() < 4) return null;  		String sub = name.substring(0, 3).toLowerCase(); 			 if ("laa".equals(sub)) return WiktionaryLAA000.get(name);
	...
	else if ("leh".equals(sub)) return WiktionaryLEH000.get(name);
	...
	else if ("ler".equals(sub)) return WiktionaryLER000.get(name);
	...
	else if ("lew".equals(sub)) return WiktionaryLEW000.get(name);
	...
	else if ("loj".equals(sub)) return WiktionaryLOJ000.get(name);
