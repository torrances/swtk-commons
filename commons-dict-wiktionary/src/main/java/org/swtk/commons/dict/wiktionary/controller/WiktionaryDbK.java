package org.swtk.commons.dict.wiktionary.controller;  import org.swtk.common.dict.dto.wiktionary.Entry;  import org.swtk.commons.dict.wiktionary.generated.k.a.b.*;
...
import org.swtk.commons.dict.wiktionary.generated.k.y.u.*;   public final class WiktionaryDbK {  	public static Entry findByName(String name) { 		if (name.length() < 4) return null;  		String sub = name.substring(0, 3).toLowerCase(); 			 if ("kab".equals(sub)) return WiktionaryKAB000.get(name);
	...
	else if ("kik".equals(sub)) return WiktionaryKIK000.get(name);
	...
	else if ("kio".equals(sub)) return WiktionaryKIO000.get(name);
	...
	else if ("koc".equals(sub)) return WiktionaryKOC000.get(name);
	...
	else if ("koi".equals(sub)) return WiktionaryKOI000.get(name);
	...
	else if ("kul".equals(sub)) return WiktionaryKUL000.get(name);
	...
	else if ("kus".equals(sub)) return WiktionaryKUS000.get(name);
	else if ("kut".equals(sub)) return WiktionaryKUT000.get(name);
	else if ("kuv".equals(sub)) return WiktionaryKUV000.get(name);
	else if ("kuw".equals(sub)) return WiktionaryKUW000.get(name);
	else if ("kwa".equals(sub)) return WiktionaryKWA000.get(name);
