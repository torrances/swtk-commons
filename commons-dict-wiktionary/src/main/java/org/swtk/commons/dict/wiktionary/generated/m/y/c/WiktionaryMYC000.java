package org.swtk.commons.dict.wiktionary.generated.m.y.c;  import java.util.Collection; import java.util.HashMap; import java.util.Map;  import org.swtk.common.dict.dto.wiktionary.Entry;  import com.trimc.blogger.commons.utils.GsonUtils;  public class WiktionaryMYC000 {  	private static Map<String, Entry> map = new HashMap<String, Entry>();  	static { 			add("mycetism", "{\"term\":\"mycetism\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"{{compound|-mycete|ism|lang\u003den}}\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"Poisoning caused by mushrooms\", \"priority\":1}]}, \"synonyms\":{}}");

	add("mycobacterium", "{\"term\":\"mycobacterium\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"\u0027myco-\u0027 + \u0027bacterium\u0027\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"Any of many rod-shaped, aerobic bacteria, of the genus \u0027Mycobacterium\u0027, that cause diseases such as tuberculosis and leprosy\", \"priority\":1}]}, \"synonyms\":{}}");
