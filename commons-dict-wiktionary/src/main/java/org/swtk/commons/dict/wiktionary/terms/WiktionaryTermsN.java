...
import org.swtk.commons.dict.wiktionary.generated.z.y.t.*;  public final class WiktionaryTermsN {  	public static Collection<String> terms() { 		Set<String> set = new TreeSet<String>();  		set.addAll(WiktionaryAAC000.terms());
