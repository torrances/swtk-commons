package org.swtk.commons.dict.wiktionary.generated.l.u.t;  import java.util.Collection; import java.util.HashMap; import java.util.Map;  import org.swtk.common.dict.dto.wiktionary.Entry;  import com.trimc.blogger.commons.utils.GsonUtils;  public class WiktionaryLUT000 {  	private static Map<String, Entry> map = new HashMap<String, Entry>();  	static { 			add("lutz", "{\"term\":\"lutz\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"From the surname of Austrian skater wikipedia:Alois Lutz|Alois Lutz who invented the jump.\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"A jump in which the skater takes off from the back outside edge of one skate, rotates counterclockwise and lands on the back outside edge of the other skate\", \"priority\":1}]}, \"synonyms\":{}}");
