package org.swtk.commons.dict.wiktionary.controller;  import org.swtk.common.dict.dto.wiktionary.Entry;  import org.swtk.commons.dict.wiktionary.generated.x.a.c.*;
...
import org.swtk.commons.dict.wiktionary.generated.x.y.s.*;   public final class WiktionaryDbX {  	public static Entry findByName(String name) { 		if (name.length() < 4) return null;  		String sub = name.substring(0, 3).toLowerCase(); 			 if ("xac".equals(sub)) return WiktionaryXAC000.get(name);
	...
	else if ("xol".equals(sub)) return WiktionaryXOL000.get(name);
