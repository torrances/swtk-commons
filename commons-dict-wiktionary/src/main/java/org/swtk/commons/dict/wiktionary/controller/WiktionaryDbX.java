...
public final class WiktionaryDbX {
	public static Entry findByName(String name) {
		...
		if ("xac".equals(sub))
			return WiktionaryXAC000.get(name);
		else if ("xan".equals(sub))
			return WiktionaryXAN000.get(name);
		else if ("xav".equals(sub))
			return WiktionaryXAV000.get(name);
		...
		else if ("xib".equals(sub))
			return WiktionaryXIB000.get(name);
		else if ("xil".equals(sub))
			return WiktionaryXIL000.get(name);
		else if ("xim".equals(sub))
			return WiktionaryXIM000.get(name);
		else if ("xin".equals(sub))
			return WiktionaryXIN000.get(name);
		else if ("xip".equals(sub))
			return WiktionaryXIP000.get(name);
		...
		else if ("xon".equals(sub))
			return WiktionaryXON000.get(name);
		else if ("xti".equals(sub))
			return WiktionaryXTI000.get(name);
		else if ("xyl".equals(sub))
			return WiktionaryXYL000.get(name);
		else if ("xyn".equals(sub))
			return WiktionaryXYN000.get(name);
