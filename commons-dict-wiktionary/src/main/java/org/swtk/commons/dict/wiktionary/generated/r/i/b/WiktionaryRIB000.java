package org.swtk.commons.dict.wiktionary.generated.r.i.b;  import java.util.HashMap; import java.util.Map;  import org.swtk.common.dict.dto.wiktionary.Entry;  import com.trimc.blogger.commons.utils.GsonUtils;  public class WiktionaryRIB000 {  	private static Map<String, Entry> map = new HashMap<String, Entry>();  	static { 			add("riba", "{\"term\":\"riba\", \"etymology\":{\"influencers\":[], \"languages\":[\"Arabic\", \"English\"], \"text\":\"Arabic \u0027ربا\u0027\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"interest or usury, which is haram (sinful) according to sharia law\", \"priority\":1}]}, \"synonyms\":{}}");

	add("ribat", "{\"term\":\"ribat\", \"etymology\":{\"influencers\":[], \"languages\":[], \"text\":\"From the Arabic {{l|ar|رباط}} {{IPAchar|(ribāʈ)}}, hospice, hostel.\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"An Islamic monastery\", \"priority\":1}]}, \"synonyms\":{}}");
	...
	add("ribose", "{\"term\":\"ribose\", \"etymology\":{\"influencers\":[], \"languages\":[\"German\", \"English\"], \"text\":\"From German {{m|de|Ribose}}, formed from {{m|de|Ribonsäure}}, the first element of which comes from a rearrangement of English {{m|en|arabinose}}.\"}, \"definitions\":{\"list\":[{\"upperType\":\"NOUN\", \"text\":\"A naturally occurring pentose sugar, which is a component of the nucleosides and nucleotides that comprise the nucleic acid biopolymer, RNA. It is also found in riboflavin\", \"priority\":1}]}, \"synonyms\":{}}");
