package org.swtk.commons.dict.wiktionary.controller;  import org.swtk.common.dict.dto.wiktionary.Entry;  import org.swtk.commons.dict.wiktionary.generated.z.a.a.*;
...
import org.swtk.commons.dict.wiktionary.generated.z.y.t.*;   public final class WiktionaryDbZ {  	public static Entry findByName(String name) { 		if (name.length() < 4) return null;  		String sub = name.substring(0, 3).toLowerCase(); 			 if ("zaa".equals(sub)) return WiktionaryZAA000.get(name);
	...
	else if ("zek".equals(sub)) return WiktionaryZEK000.get(name);
	...
	else if ("zet".equals(sub)) return WiktionaryZET000.get(name);
	...
	else if ("zho".equals(sub)) return WiktionaryZHO000.get(name);
	else if ("zhy".equals(sub)) return WiktionaryZHY000.get(name);
	else if ("zic".equals(sub)) return WiktionaryZIC000.get(name);
	else if ("zig".equals(sub)) return WiktionaryZIG000.get(name);
	...
	else if ("ziz".equals(sub)) return WiktionaryZIZ000.get(name);
	else if ("zlo".equals(sub)) return WiktionaryZLO000.get(name);
	else if ("zoa".equals(sub)) return WiktionaryZOA000.get(name);
	else if ("zod".equals(sub)) return WiktionaryZOD000.get(name);
	...
	else if ("zom".equals(sub)) return WiktionaryZOM000.get(name);
	...
	else if ("zuc".equals(sub)) return WiktionaryZUC000.get(name);
	...
	else if ("zum".equals(sub)) return WiktionaryZUM000.get(name);
	else if ("zun".equals(sub)) return WiktionaryZUN000.get(name);
	else if ("zur".equals(sub)) return WiktionaryZUR000.get(name);
	else if ("zwi".equals(sub)) return WiktionaryZWI000.get(name);
