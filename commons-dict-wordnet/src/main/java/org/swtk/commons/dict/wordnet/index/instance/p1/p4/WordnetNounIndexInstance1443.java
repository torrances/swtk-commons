package org.swtk.commons.dict.wordnet.index.instance.p1.p4;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance1443 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("14430304", "{\"term\":\"bummer\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"14335136\", \"14430304\"]}");
