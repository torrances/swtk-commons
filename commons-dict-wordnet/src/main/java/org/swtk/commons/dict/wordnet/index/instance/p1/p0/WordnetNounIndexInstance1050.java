package org.swtk.commons.dict.wordnet.index.instance.p1.p0;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance1050 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("10500168", "{\"term\":\"pro\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"06661968\", \"10500168\"]}");
