package org.swtk.commons.dict.wordnet.index.instance.p0.p9;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance0929 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("09290034", "{\"term\":\"dipole molecule\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09290034\"]}");
