package org.swtk.commons.dict.wordnet.index.instance.p0.p3;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance0309 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("03090225", "{\"term\":\"concentration camp\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"14472158\", \"03090225\"]}");
