package org.swtk.commons.dict.wordnet.index.instance.p0.p7;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance0728 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("07280087", "{\"term\":\"foghorn\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"03380017\", \"07280087\"]}");
