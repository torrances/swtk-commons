package org.swtk.commons.dict.wordnet.index.instance.p1.p0;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance1058 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("10580065", "{\"term\":\"scientist\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"10580065\"]}");
