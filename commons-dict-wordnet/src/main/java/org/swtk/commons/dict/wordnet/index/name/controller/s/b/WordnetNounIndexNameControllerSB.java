package org.swtk.commons.dict.wordnet.index.name.controller.s.b;  import java.util.Collection; import java.util.Set; import java.util.TreeSet;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  	import org.swtk.commons.dict.wordnet.index.name.instance.s.s.p.e.WordnetNounIndexNameInstanceSSPE;
	import org.swtk.commons.dict.wordnet.index.name.instance.s.s.r.i.WordnetNounIndexNameInstanceSSRI;
  import com.trimc.blogger.commons.exception.BusinessException;  public final class WordnetNounIndexNameControllerSB {  	public static Collection<IndexNoun> get(final String TERM) throws BusinessException {  		String key = TERM.substring(0, 4).toLowerCase(); 			if ("sspe".equals(key)) return WordnetNounIndexNameInstanceSSPE.get(TERM);
