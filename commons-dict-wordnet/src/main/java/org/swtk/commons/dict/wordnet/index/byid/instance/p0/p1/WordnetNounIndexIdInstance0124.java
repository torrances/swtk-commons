package org.swtk.commons.dict.wordnet.index.byid.instance.p0.p1;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexIdInstance0124 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("01240437", "{\"term\":\"centralisation\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"01017117\", \"01240437\"]}");
