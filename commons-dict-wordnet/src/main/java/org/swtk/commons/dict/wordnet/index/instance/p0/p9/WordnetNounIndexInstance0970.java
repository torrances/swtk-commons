package org.swtk.commons.dict.wordnet.index.instance.p0.p9;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance0970 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("09700053", "{\"term\":\"papist\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09700053\"]}");
