package org.swtk.commons.dict.wordnet.index.instance.p0.p4;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance0443 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("04430010", "{\"term\":\"thermoregulator\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"04430010\"]}");
