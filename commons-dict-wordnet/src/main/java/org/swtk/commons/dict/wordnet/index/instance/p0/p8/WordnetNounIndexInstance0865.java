package org.swtk.commons.dict.wordnet.index.instance.p0.p8;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexInstance0865 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("08650253", "{\"term\":\"loxodrome\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"08650253\"]}");
