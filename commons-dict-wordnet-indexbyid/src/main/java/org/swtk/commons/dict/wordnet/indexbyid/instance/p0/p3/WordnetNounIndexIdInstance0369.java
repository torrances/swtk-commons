package org.swtk.commons.dict.wordnet.indexbyid.instance.p0.p3;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexIdInstance0369 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("03690066", "{\"term\":\"lockup\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"00829299\", \"03690066\"]}");
