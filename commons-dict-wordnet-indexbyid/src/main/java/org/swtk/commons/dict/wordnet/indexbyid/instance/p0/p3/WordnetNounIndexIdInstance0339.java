package org.swtk.commons.dict.wordnet.indexbyid.instance.p0.p3;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexIdInstance0339 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("03390141", "{\"term\":\"formica\", \"synsetCount\":2, \"upperType\":\"NOUN\", \"ids\":[\"02223892\", \"03390141\"]}");
