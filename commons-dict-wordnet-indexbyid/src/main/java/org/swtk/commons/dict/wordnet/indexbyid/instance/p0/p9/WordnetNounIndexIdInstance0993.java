package org.swtk.commons.dict.wordnet.indexbyid.instance.p0.p9;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexIdInstance0993 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("09930014", "{\"term\":\"chartered accountant\", \"synsetCount\":1, \"upperType\":\"NOUN\", \"ids\":[\"09930014\"]}");
