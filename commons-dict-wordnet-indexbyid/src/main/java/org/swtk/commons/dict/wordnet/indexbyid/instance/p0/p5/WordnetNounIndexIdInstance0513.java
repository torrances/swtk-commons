package org.swtk.commons.dict.wordnet.indexbyid.instance.p0.p5;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexIdInstance0513 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("05130115", "{\"term\":\"minority\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"15177221\", \"05130115\", \"07983184\"]}");
