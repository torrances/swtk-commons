package org.swtk.commons.dict.wordnet.indexbyid.instance.p0.p3;  import java.util.ArrayList; import java.util.Collection; import java.util.Map; import java.util.TreeMap;  import org.swtk.common.dict.dto.wordnet.IndexNoun;  import com.trimc.blogger.commons.utils.GsonUtils;  public final class WordnetNounIndexIdInstance0330 {  	private static Map<String, Collection<IndexNoun>> map = new TreeMap<String, Collection<IndexNoun>>();  	static { 			add("03300069", "{\"term\":\"erection\", \"synsetCount\":3, \"upperType\":\"NOUN\", \"ids\":[\"00913583\", \"03300069\", \"14061667\"]}");
